...
const SearchableDropdown: React.FC<any> = ({
  label,
  searchResult,
  selectedTab,
  onSelect,
  ...
  return (
    <div>
      <div
        className={`cursor-pointer p-2   h-[4.5rem] rounded-md relative border-2  ${
      ...
      >
        ...
        <p className="font-semibold text-sm">
          {textLabel?.code} - {textLabel?.label}
        </p>
      </div>
